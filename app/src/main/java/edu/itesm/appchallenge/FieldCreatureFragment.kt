...
class FieldCreatureFragment : Fragment() {
    //private val args by navArgs<FieldsFragmentArgs>()
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        //picture.setImageResource(args.field.picture)
        //name.text = args.fields_args.name
        //description.text = args.movie.description
    }
}